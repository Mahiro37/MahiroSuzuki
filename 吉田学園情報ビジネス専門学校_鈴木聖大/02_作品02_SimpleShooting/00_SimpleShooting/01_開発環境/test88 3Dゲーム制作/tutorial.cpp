...
void InitTutorial(void)
{
	...
	// テクスチャの読み込み
	D3DXCreateTextureFromFile(pDevice, "テクスチャ/tutorial.png",&g_pTexturePolygonTutorial);
	...
	g_pVtxBuffPolygonTutorial->Lock(0, 0, (void**)&pVtx, 0);
...
{
	if (GetKeyboardTrigger(DIK_SPACE) || GetJoypadTrigger(11))
	{
		SetMode(MODE_GAME);
	}
}
